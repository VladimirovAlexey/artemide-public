!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!			Model for Collins TMD FF [20??.????]
!
!				A.Vladimirov (21.05.2020)
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module CollinsTMDFF_model
use aTMDe_Numerics
use aTMDe_IO
implicit none
...
subroutine ModelInitialization(lengthNP)
    ...
    write(*,*) color(">>>  The model for Collins function is _____. Please, cite [20??.????]   <<<",c_cyan)
...
!!! UPDATE WITH MODEL FOR COLLINS FUNCTION
