...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine ModelInitialization()  
    ...
    write(*,*) 'Model BSV19.CT14 is used. Please, cite 1902.08474'
 ...
 real,parameter,dimension(1:618)::replicas=(/&
  ...
  if(rep>100) then
   write(*,*) 'ERROR in BSM19.HER20PDF model. It has only 100 replicas. Central replica is set'
   rep=0
  end if
